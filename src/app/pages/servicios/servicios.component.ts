...
export class ServiciosComponent {
  ...
  setUrlVerMas() {
    ...
    this.dataView = [
      ...
      { label: 'Plantación', field: 'cropDescripcion', tipoLabel: TipoLabel.span },
      ...
      { label: 'servicio', field: this.urlBase + '/servicios/', tipoLabel: TipoLabel.botonVermas },
    ]
  }

  getServiciosByProductor() {
    this.serviciosService.getServiciosByProductor()
