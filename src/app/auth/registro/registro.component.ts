...
export class RegistrateComponent {
  ...
  togglePasswordVisibility(): void {
    ...
    passwordInput.type = confirmPasswordInput.type = this.passwordVisible
      ? 'text'
      : 'password';
  }
  ...
  manejarErrorRegistro(err: any) {
    ...
    if (
      ...
      this.toastr.error(
        'Ocurrió un error de conexión. Por favor, inténtelo de nuevo más tarde.',
        'Error de Conexión'
      );
    } else {
      this.toastr.error(
