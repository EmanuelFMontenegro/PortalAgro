...
public class FieldService {
    ...
    public void addField(Long person_id, FieldResponseDTO fieldResponseDTO) {
        ...
        Person person = this.personSVC.getPersonById(person_id);
        Location location = this.locationSVC.getLocationById(fieldResponseDTO.getAddress().getLocation_id());
        Field field = Field.builder()
                .name(fieldResponseDTO.getName())
                .dimensions(fieldResponseDTO.getDimensions())
                .observation(fieldResponseDTO.getObservation())
                .geolocation(fieldResponseDTO.getGeolocation())
                .address(Address.builder()
                        .address(fieldResponseDTO.getAddress().getAddress())
                        .location(location)
                        .build())
        ...
        log.info("Field create: " + newField.toString());
    }
